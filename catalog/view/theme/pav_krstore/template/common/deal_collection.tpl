...
<div id="products"> 
	<div class="products-block">
		...
		?>
		<div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-6 col-xs-12 product-deals product-col">			
...
<div class="pagination-link paging clearfix"><?php echo $pagination; ?></div>